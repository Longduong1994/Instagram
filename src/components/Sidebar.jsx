...
function Sidebar() {
        ...
        listAll(imagesListRef).then((res) => {
            res.items.forEach((item) => {
                getDownloadURL(item).then((url) => {
                    // Không cần lưu trữ tất cả các URL ảnh
                });
            });
        });
    }, []);
    ...
    const handlePost = async () => {
        try {
            ...
            setPostTitle("");
            setImageUpload(null);
            setLatestImageUrl(""); // Xóa bỏ link URL
    ...
    useEffect(() => {
        setSearchBoxWidth(showSearch ? 400 : 0);
    }, [showSearch]);
    ...
    useEffect(() => {
        if (keyword.trim() === '') {
            setUser([]); // Set users về một mảng rỗng khi keyword rỗng
        } else {
            axios
                .get(`http://localhost:5000/user?username_like=${keyword}`)
        ...
        <div >
            <div className="sidebar-left">
                ...
                <div>
                    <div className="list-action">
                        ...
                        <NavLink className='action' onClick={handShowSearch}>
                            <svg
                                aria-label="Search"
                                className="_ab6-"
                                color="rgb(0, 0, 0)"
                        ...
                        <NavLink to="/explore" className='action'>
                            <svg
                                aria-label="Explore"
                                className="_ab6-"
                                color="rgb(0, 0, 0)"
                        ...
                        <NavLink to="/reels" className='action'>
                            <svg
                                aria-label="Reels"
                                className="_ab6-"
                                color="rgb(0, 0, 0)"
                        ...
                        <NavLink to="/mesages" className='action'>
                            <svg
                                aria-label="Direct"
                                className="_ab6-"
                                color="rgb(0, 0, 0)"
                        ...
                        <NavLink className='action' onClick={handleShowCreate}>
                            <svg
                                aria-label="New post"
                                className="_ab6-"
                                color="rgb(0, 0, 0)"
                        ...
                        <NavLink to="/user" className='action'>
                            <img
                                src={(currentUser) ? (currentUser.avatar || avatar) : avatar}
                                alt=""
                            />
                            <span> Profile</span>
                        </NavLink>
                ...
                <div className="bars" onClick={handleMore} >
                    <svg
                        aria-label="Settings"
                        className="_ab6-"
                        color="rgb(0, 0, 0)"
            ...
            {showSearch && (
                <div className='search-box'>
                    ...
                    <div className='listSearch-user-box'>
                        {users.length > 0 ? (
                            users.map((user) => (
                ...
                <div className='create-main'>
                    <div className='create-box'>
                        <div className='create-title'>
                            ...
                            <button className='btn-close-post' onClick={handClose}><i class="fa-regular fa-rectangle-xmark"></i></button>
                        </div>
                        <input className='input-file-post'
                            type='file'
                            onChange={(e) => {
                        ...
                        {latestImageUrl && <img className='create-img' src={latestImageUrl} />}
                        </div>
                        </div>
                        <button className=' btn-upload-post' onClick={uploadFile}>Upload Image</button>
                        <div>
                            <label className='post-title'>
                                ...
                                />
                            <button className='btn-create' onClick={handlePost}>Post</button>
                            </label>
                        </div>
                    </div>
                </div>
